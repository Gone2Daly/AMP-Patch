...
economy = {
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 1.0,	-- how fast pops are Hired when there is a high demand
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 1.0,	-- how fast pops are Hired when there is a medium demand
	...
	TRADE_CAP_LOW_LIMIT_NAVAL = 0.20, 			-- the lowest % the slider can go for naval units
